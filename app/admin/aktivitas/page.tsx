...
import { getAktivitas } from "@/app/admin/actions/aktivitas";
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-slate-900">Aktivitas</h2>
                    <p className="text-slate-500">Kelola daftar aktivitas dan wisata Dieng.</p>
                </div>
                <Link
                    href="/admin/aktivitas/create"
