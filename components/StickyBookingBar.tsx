...
export function StickyBookingBar({ price, label, onBook }: StickyBookingBarProps) {
    ...
    return (
        <div className="fixed bottom-0 left-0 z-40 w-full border-t border-neutral-200 bg-white/90 p-4 backdrop-blur-md   sm:hidden">
            <div className="mx-auto flex max-w-7xl items-center justify-between gap-4">
                <div>
                    <p className="text-xs font-medium text-neutral-500 ">Mulai dari</p>
